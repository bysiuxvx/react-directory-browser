...
interface IContentItem {
    item: any
    onDirectorySelect: (directory: IDirectory) => void
}

const ContentItem: React.FC<IContentItem> = ({item, onDirectorySelect}) => {
    ...
    return (
        <Tooltip label={item.name}>
            <Center
                ...
                overflow={'hidden'}
                borderRadius="7"
                style={item.type === 'directory' ? {cursor: 'pointer'} : undefined}
            >
